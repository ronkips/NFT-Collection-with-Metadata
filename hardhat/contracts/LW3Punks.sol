...
contract LW3Punks is ERC721Enumerable, Ownable {
    ...
    // price is the price of one LW3Punks
    uint256 public _price = 0.001 ether;

    // Pause is used to pause the contract in case of emergency
    bool public _paused;
    ...
    //constructor takes in a `name` and a `symbol` to the token collection.
